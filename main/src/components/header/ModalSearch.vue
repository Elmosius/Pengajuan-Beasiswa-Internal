        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li>
                <router-link
                  class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group"
                  to="#0"
              ...
              <li>
                ...
                >
                  ...
                  <span
                    ...
                    <span class="text-slate-600 dark:text-slate-400 group-hover:text-white"
