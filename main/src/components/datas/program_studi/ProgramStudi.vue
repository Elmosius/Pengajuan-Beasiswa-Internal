      ...
      >
        <div class="max-w-full overflow-x-auto">
          <table class="w-full table-auto">
            ...
            <tbody>
              <tr v-for="prodi in prodiList.data" :key="prodi.id">
                ...
                <td class="py-5 px-4">
                  <div class="flex items-center space-x-3.5">
                    <router-link
                      :to="`/data/program-studi-edit/${prodi.id}`"
                    ...
                    <button @click="confirmDelete(prodi.id)" class="hover:text-purple-500">
                      <svg
                        class="fill-current"
                        width="18"
                        height="18"
...
export default {
  ...
  methods: {
    ...
    async deleteProdi() {
      ...
      try {
        await Api.deleteProgramStudi(this.selectedProdiId)
        this.closeModal()
        this.fetchProdi()
      } catch (error) {
